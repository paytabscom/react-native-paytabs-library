...
sed -i.bak "s/React%20Native%20Paytabs-v[0-9][0-9.]*-green/React%20Native%20Paytabs-v${NEW_VERSION}-green/g" README.md

# Update the npm install command
# Replace @paytabs/react-native-paytabs@2.7.0 with @paytabs/react-native-paytabs@$NEW_VERSION
sed -i.bak "s/paytabs\/react-native-paytabs@[0-9][0-9.]*/paytabs\/react-native-paytabs@${NEW_VERSION}/g" README.md
